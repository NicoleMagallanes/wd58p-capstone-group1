...
<body class="antialiased">
    ...
    <!-- Section: Tested Block -->
    <div class="mb-32 text-gray-800 text-center bg-dots-darker bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        <style>
            .grayscale {
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-6 px-6 p-6">
            <div class="mb-12 lg:mb-0 mx-auto">
                <img src="https://mdbootstrap.com/img/Photos/new-templates/landing-page/8.png" class="img-fluid grayscale" style="max-width: 90px" />
            </div>

            <div class="mb-12 lg:mb-0 mx-auto">
                <img src="https://mdbootstrap.com/img/Photos/new-templates/landing-page/2.png" class="img-fluid grayscale" style="max-width: 90px" />
            </div>

            <div class="mb-12 lg:mb-0 mx-auto">
                <img src="https://mdbootstrap.com/img/Photos/new-templates/landing-page/7.png" class="img-fluid grayscale" style="max-width: 90px" />
            </div>

            <div class="mb-12 lg:mb-0 mx-auto">
                <img src="https://mdbootstrap.com/img/Photos/new-templates/landing-page/1.png" class="img-fluid grayscale" style="max-width: 90px" />
            </div>

            <div class="mb-12 lg:mb-0 mx-auto">
                <img src="https://mdbootstrap.com/img/Photos/new-templates/landing-page/4.png" class="img-fluid grayscale" style="max-width: 90px" />
            </div>

            <div class="mb-12 lg:mb-0 mx-auto">
                <img src="https://mdbootstrap.com/img/Photos/new-templates/landing-page/5.png" class="img-fluid grayscale" style="max-width: 90px" alt="Sony - logo" />
            </div>
        </div>
    </div>
