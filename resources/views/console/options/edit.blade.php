<x-app-layout>
    <x-slot name="header">
        ...
        <a href="/manage/options">Back to List</a>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form id="record-data" method="post" action="{{ $option->id > 0 ? route('options.update', $option->id) : route('options.store') }}" class="mt-6 space-y-6" onsubmit="return validatePassword()">
                        @csrf
                        @if($option->id > 0)
                            @method('patch')
                        @endif
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="email" name="email" type="email"  value="{{ $option->email }}" class="mt-1 block w-full" required/>
